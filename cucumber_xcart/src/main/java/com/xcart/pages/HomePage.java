...
public class HomePage extends Utility {
    ...
    //This method will click on new account tab
    public void clickOnNewAccountTab() {
        Reporter.addStepLog("Clicking on new Account tab" + _createNewAccountTab.toString() + "<br>");
    ...
    public void enterEmailAddressToEmailField() {
        ...
        Reporter.addStepLog("enter email address" + _emailField.toString() + "<br>");
    ...
    public void enterPasswordToPasswordField(String password) {
        Reporter.addStepLog("enter password" + _passwordField.toString() + "<br>");
    ...
    public void enterPasswordToConfirmPasswordField(String confirmPassword) {
        Reporter.addStepLog("enter confirm password" + _ConfirmPasswordField.toString() + "<br>");
    ...
    public void clickOnCreateButton() {
        ...
        Reporter.addStepLog("clicking on create button" + _createButton.toString() + "<br>");
    ...
    public String VerifyUserShouldNavigateToMyAccountPage() {
        Reporter.addStepLog("get text from account successfully" + _myAccountText.toString() + "<br>");
    ...
    public void clickOnHomePageTab() {
        Reporter.addStepLog("Clicking on homePage tab" + _homeTab.toString() + "<br>");
        log.info("Clicking on homePage tab" + _homeTab.toString());
        clickOnElement(_homeTab);

    }

    //this method will verify that user is on home page
    public String VerifyUserShouldNavigateToHomePage() {
        Reporter.addStepLog("get text from home page successfully" + _HomePageText.toString() + "<br>");
    ...
    public void clickOnElectronicButton() {
        Reporter.addStepLog("Clicking on electronicButton" + _electronicButton.toString() + "<br>");
    ...
    public void clickOnNewTab() {
        Reporter.addStepLog("Clicking on new tab" + _newTab.toString() + "<br>");
